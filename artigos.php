...
<head>
  <meta charset="UTF-8">
  <title>Artigos - Jornal Jovem Marista</title>
...
<body>
  ...
  <section class="noticias">
    ...
    <form method="get" action="artigos.php" class="search-bar">
      <input type="text" name="search" placeholder="Buscar artigos..." value="<?= htmlspecialchars($search) ?>">
        ...
        <?php foreach ($news as $item): ?>
          <div class="card">
            <?php if (!empty($item['image'])): ?>
              <img src="<?= htmlspecialchars($item['image']) ?>" alt="Imagem do artigo">
            <?php endif; ?>
