...
<head>
  <meta charset="UTF-8">
  <title>Avisos - Jornal Jovem Marista</title>
...
<body>
  ...
  <section class="noticias">
    ...
    <form method="get" action="avisos.php" class="search-bar">
      <input type="text" name="search" placeholder="Buscar avisos..." value="<?= htmlspecialchars($search) ?>">
        ...
        <?php foreach ($news as $item): ?>
          <div class="card">
            <?php if (!empty($item['image'])): ?>
              <img src="<?= htmlspecialchars($item['image']) ?>" alt="Imagem do aviso">
            <?php endif; ?>
